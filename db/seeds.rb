...
# ApplicationRecord.transaction do 
  ...
  ValorantGiftCard = Item.create!({
    ...
    stock: "138",
    description: "The perfect gift for anyone who plays VALORANT or trying it out for the first time.
  ...
  CorsairVirtuoso = Item.create!({
    ...
    category: "Headset",
    stock: "53",
    description: "Simultaneous Dual-wireless Connections: Get high-fidelity 24bit/48KHz game audio with hyper-fast, ultra-long range SLIPSTREAM CORSAIR WIRELESS TECHNOLOGY, plus Bluetooth with Qualcomm aptX HD.
  ...
  CorsairMouse = Item.create!({
    ...
    category: "Mouse",
    stock: "94",
    description: "0.13lb – Ultra Lightweight for Quick, Precise FPS Play: Not just light. Ultra-light. Free of unneeded frills to achieve the lightest weight possible at 0.13lbs, M75 AIR provides only what you need to win.
  ...
  CorsairKeyboard = Item.create!({
    ...
    category: "Keyboard",
    stock: "73",
    description: "Small Size, Big Features: The K65 RGB MINI delivers big features compressed into a 60% form-factor to easily fit into even the tightest spaces for comfortable gaming.
    ...
    100% CHERRY MX SPEED RGB Silver Mechanical Keyswitches: Lightning-fast response times with a 1.2mm actuation distance, registering up to 4x faster than standard mechanical keyboards with CORSAIR AXON.
    Personalize Your Play: Show off your style with dynamic per-key RGB backlighting as well as an optional included radiant spacebar and CORSAIR logo key, along with a standard bottom row layout.
